...
def batch_run(scenario: Scenario, parameters: ParametersType, num_samples: int) -> list[Scenario]:
    ...
    for kwargs in kwargs_list:
        ...
        strategy_name = None
        if "adaptation_strategy" in kwargs:
            strategy_name = kwargs["adaptation_strategy"]
        elif new_scenario.adaptation_strategy is not None:
            strategy_name = str(new_scenario.adaptation_strategy)
